...
namespace TrickCore
{
    ...
    public class RESTGet<T> : RESTBase
    {
        ...
        public RESTGet(string uri, KeyValuePair<string, string>[] param = null, Action<T> onCallback = null, RequestFailHandler failHandler = null)
        {
    ...
    public class RESTCertificateHandlepacker : CertificateHandler
    {
        protected override bool ValidateCertificate(byte[] certificateData)
        {
            return Application.isEditor || base.ValidateCertificate(certificateData);
        }
    }
}
#endif