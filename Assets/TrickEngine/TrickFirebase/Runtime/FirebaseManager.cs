...
namespace TrickCore
{
    public class FirebaseManager : MonoSingleton<FirebaseManager>
    {
        ...
        [Preserve] public void ForgetPasswordCallback(string s) => Exec(true, false, nameof(ForgetPasswordCallback).Replace("Callback", string.Empty), s);
        [Preserve] public void ForgetPasswordFallback(string s) => Exec(false, false, nameof(ForgetPasswordFallback).Replace("Fallback", string.Empty), s);
        [Preserve] public void ChangePasswordCallback(string s) => Exec(true, false, nameof(ChangePasswordCallback).Replace("Callback", string.Empty), s);
        [Preserve] public void ChangePasswordFallback(string s) => Exec(false, false, nameof(ChangePasswordFallback).Replace("Fallback", string.Empty), s);
